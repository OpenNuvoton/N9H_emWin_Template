...
void LCD_X_Config(void)
{
    ...
    if (LCD_GetSwapXY())
    {
        LCD_SetSizeEx (0, YSIZE_PHYS_OSD, XSIZE_PHYS_OSD);
        LCD_SetVSizeEx(0, YSIZE_PHYS_OSD * NUM_VSCREENS, XSIZE_PHYS_OSD);
    }
    else
    {
        LCD_SetSizeEx (0, XSIZE_PHYS_OSD, YSIZE_PHYS_OSD);
        LCD_SetVSizeEx(0, XSIZE_PHYS_OSD, YSIZE_PHYS_OSD * NUM_VSCREENS);
    }
//    LCD_SetVRAMAddrEx(0, (void *)u8FrameBufPtr);
    LCD_SetVRAMAddrEx(0, (void *)u8OSDFrameBufPtr);
