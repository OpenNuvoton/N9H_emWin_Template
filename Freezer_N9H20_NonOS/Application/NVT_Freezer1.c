...
#define NVT_FREEZER_BACKGROUND "D:\\freezer_background.jpg"
#define NVT_FREEZER_BUTTON1 "D:\\freezer_back.dta"
...
void NVT_Freezer1SetBackground(WM_HWIN hItem)
{
    ...
    if (i32FileSize == 0)
        i32FileSize = NVT_GetImage(NVT_FREEZER_BACKGROUND, s_u8BackgroundImageBuf);
...
static int _ButtonSkin(const WIDGET_ITEM_DRAW_INFO * pDrawItemInfo)
{
    ...
    case WIDGET_ITEM_DRAW_BITMAP:
        ...
        case 1:
            ...
            {
                if (i32FileSize == 0)
                    i32FileSize = NVT_GetImage(NVT_FREEZER_BUTTON1, s_u8Button1ImageBuf);
