...
#define COLOR_BORDER      GUI_MAKE_COLOR(0x880000)
...
*       _GraphDemo
*/
static void _GraphDemo(WM_HWIN hWin) {
  ...
  hGraph = GRAPH_CreateEx(Graph_xPos, Graph_yPos, Graph_xSize, Graph_ySize, hWin, WM_CF_SHOW | WM_CF_CONST_OUTLINE, 0, 0);
...
**********************************************************************
*/
void GUIDEMO_Graph(WM_HWIN hWin) {
  _GraphDemo(hWin);
}
