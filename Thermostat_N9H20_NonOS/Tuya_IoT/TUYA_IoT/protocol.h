...
******************************************************************************/
/******************************************************************************
Please refer to N9H20_emWin_NonOS-master\BSP\Driver\Source\TUYA_IoT
to create your TUYA_IoT library with your product key.
Please note that copy N9H20_emWin_NonOS-master\BSP\Library\IPLib\TUYA_IoT.lib
to N9H20_emWin_NonOS-master\BSP\SampleCode\emWin\Thermostat_N9H20_NonOS\Tuya_IoT and compile Thermostat again.

#define PRODUCT_KEY     //开发平台创建产品后生成的16位字符产品唯一标识
******************************************************************************/
/*
Please fill correct PID to "PRODUCT"
More details can be found in N9H20_emWin_NonOS-master\BSP\SampleCode\emWin\Thermostat_N9H20_NonOS\Doc\Thermostat_HMI_with_Tuya_IoT_Template.pdf
*/
#define PRODUCT_KEY "please fill your PID"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//背光亮度(可下发可上报)
//备注:
#define DPID_BACKLIGHT 44
//Menu2_Temp1(可下发可上报)
//备注:
#define DPID_MENU2_TEMP1 101
//Menu2_Temp1_Modbus(可下发可上报)
//备注:
#define DPID_MENU2_TEMP1_MODBUS 102
//Menu1_Mode1(可下发可上报)
//备注:
#define DPID_MENU1_MODE1 103
//Menu1_Mode1_Mode1(可下发可上报)
//备注:
#define DPID_MENU1_MODE1_MODE1 104
//Menu1_Mode1_Mode2(可下发可上报)
//备注:
#define DPID_MENU1_MODE1_MODE2 105
//Menu1_Mode1_Mode3(可下发可上报)
//备注:
#define DPID_MENU1_MODE1_MODE3 106
//Menu(可下发可上报)
//备注:
#define DPID_MENU 107
//Menu3_Date1(可下发可上报)
//备注:
#define DPID_MENU3_DATE1 108
//Menu3_Date1_Date1(可下发可上报)
//备注:
#define DPID_MENU3_DATE1_DATE1 109
//Menu3_Date1_Date2(可下发可上报)
//备注:
#define DPID_MENU3_DATE1_DATE2 110
//Menu3_Date1_Date3(可下发可上报)
//备注:
#define DPID_MENU3_DATE1_DATE3 111
//Menu1_Dehumidify(可下发可上报)
//备注:
#define DPID_MENU1_DEHUMIDIFY 112
//Menu1_Fan(可下发可上报)
//备注:
#define DPID_MENU1_FAN 113
//Menu1_Cool(可下发可上报)
//备注:
#define DPID_MENU1_COOL 114
//Menu1_Heat(可下发可上报)
//备注:
#define DPID_MENU1_HEAT 115
//Menu1_OnOff_Level(可下发可上报)
//备注:
#define DPID_MENU1_ONOFF_LEVEL 116
//Menu1_Increase_Level(可下发可上报)
//备注:
#define DPID_MENU1_INCREASE_LEVEL 117
//Menu1_Decrease_Level(可下发可上报)
//备注:
#define DPID_MENU1_DECREASE_LEVEL 118
